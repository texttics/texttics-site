...
def update_all(event=None):
    ...
    if details_line:
        ...
        if total_invis > 0:
            ...
            # [FIX] Clean Text: No brackets, renamed label, black text (via CSS), space added
            details_line.innerHTML = f"<strong>Non-Standard Invisibles: </strong> {total_invis} Found {icon_alert}"
