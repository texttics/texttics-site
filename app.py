...
def render_forensic_hud(t, stats):
    """
    Unified Forensic HUD (The Hybrid).
    Logic: Uses the 'Old' robust counting logic (C0-C7).
    Layout: Uses the 'New' V3 structure (Grid Top + Hero Bottom).
    """
    ...
    # --- INTERACTION HELPER (From Old Code) ---
